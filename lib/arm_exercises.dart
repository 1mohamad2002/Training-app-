...
class ArmExercises extends StatefulWidget {
  const ArmExercises({super.key});

  @override
  _ArmExercisesState createState() => _ArmExercisesState();
}

class _ArmExercisesState extends State<ArmExercises> {
  ...
  Future<void> fetchExercises() async {
    try {
      final response = await http.get(
        Uri.parse('http://mohamadsukkar.onlinewebshop.net/armexercises.php'),
      );
      ...
      if (response.statusCode == 200) {
        ...
        // Handle error if the API response is not successful
