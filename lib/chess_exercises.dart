...
class ChessExercises extends StatefulWidget {
  const ChessExercises({super.key});

  @override
  _ChessExercisesState createState() => _ChessExercisesState();
}

class _ChessExercisesState extends State<ChessExercises> {
  ...
  Future<void> fetchExercises() async {
    try {
      final response = await http.get(
        Uri.parse('http://mohamadsukkar.onlinewebshop.net/chessexercises.php'),
      );
